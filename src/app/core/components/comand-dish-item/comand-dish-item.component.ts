...
@Component({
  selector: 'app-comand-dish-item',
  templateUrl: './comand-dish-item.component.html',
  styleUrls: ['./comand-dish-item.component.scss'],
})
export class ComandDishItemComponent implements OnInit {
